        ...
        <div v-if="loaded" id="main">
            <div class="main-container">
                ...
                <div class="right-panel">
                    ...
                    <div class="interaction-panel">
                        <div class="tab-title">
                            <span @click="setTab('user')" class="title" :class="{ active: checkActiveTab('user') }"
                                >用户列表</span
                            >
                            ...
                            <span
                                ...
                                >聊天</span
                            >
                            <span @click="setTab('action')" class="title" :class="{ active: checkActiveTab('action') }"
                                >发言列表</span
                            >
                        </div>
                        <div class="tab-body">
            ...
            <div class="footer-panel">
                ...
                <select v-model="currentQuality" name="quality" id="quality-control" title="清晰度">
                    <option v-for="(item, index) in qualityList" :key="index" :value="item.type">
                        {{ item.name }}
                    </option>
                </select>
            </div>
...
<script>
    ...
    export default {
        ...
        created() {
            ...
            eventEmitter.on(eventEmitter.PLAYBACK_SIGNAL_FETCH_END, () => {
